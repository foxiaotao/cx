...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/css/images/title_arrow.gif"/> 修改密码
        </div>
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        <td width="100">姓名</td>
                        <td>
                        	<s:textfield name="username" cssClass="InputStyle" readonly="true"></s:textfield>
                        </td>
                    </tr>
                    <tr>
                        <td>学号</td>
                        <td>
                        	<s:textfield name="number" cssClass="InputStyle" readonly="true"></s:textfield>
                        </td>
                    </tr>
                    <tr>
                        <td>设置新密码</td>
                        <td>
                        	<s:textfield name="password" cssClass="InputStyle"></s:textfield>
                        </td>
                    </tr>
                </table>
            </div>
