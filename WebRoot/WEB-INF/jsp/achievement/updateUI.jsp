...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="achievementAction_update.action" id="achievementForm" cssClass="center" enctype="multipart/form-data">
    <s:hidden name="aid"></s:hidden>
    <table cless="center">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr>
                    	<td width="100">类型</td>
                    	<td>
                    		<s:select list="#{'0':'专利','1':'论文','2':'竞赛','3':'软件'}" name="type" cssClass="SelectStyle"></s:select>
                    	</td>	
                    </tr>
                    <tr>
                    	<td>添加佐证材料</td>
