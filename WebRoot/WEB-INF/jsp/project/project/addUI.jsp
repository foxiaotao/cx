...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="projectAction_add.action" id="projectForm" cssClass="center">
    <table cless="center">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr>
                    	<td width="100">状态</td>
                    	<td>
                    		<s:select list="#{'0':'立项','1':'中期检查','2':'结题'}" name="statue" id="statue" cssClass="SelectStyle"></s:select>	
                    	</td>	
                    </tr>
                    <tr>
                    	<td width="100">等级</td>
